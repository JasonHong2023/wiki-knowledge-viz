...
(function(react, react_jsx_runtime) {
	...
	*/
	...
	//#endregion
	//#region src/WikiRefreshContext.tsx
	var WikiRefreshContext = (0, react.createContext)({
		refreshKey: 0,
		refresh: () => {}
	});
	function WikiRefreshProvider({ children }) {
		const [refreshKey, setRefreshKey] = (0, react.useState)(0);
		const refresh = (0, react.useCallback)(() => setRefreshKey((k) => k + 1), []);
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(WikiRefreshContext.Provider, {
			value: {
				refreshKey,
				refresh
			},
	...
	function useWikiRefresh() {
		return (0, react.useContext)(WikiRefreshContext);
	}
	//#endregion
	//#region src/api.ts
...
Please report this to https://github.com/markedjs/marked.`, e) {
	...
	function Markdown({ content }) {
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			dangerouslySetInnerHTML: { __html: (0, react.useMemo)(() => g.parse(content), [content]) }
		});
	}
	//#endregion
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [onDelete && page && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(X$1, { className: "h-4 w-4" })
						})]
					})]
				}),
				loading && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				!loading && !error && page && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h4", {
							...
							className: "max-h-96 overflow-auto rounded border border-current/10 p-3 text-xs leading-relaxed text-text-primary",
							children: page.content ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Markdown, { content: page.content }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "italic text-text-tertiary",
								children: "(empty)"
							})
						})] })
	...
	function App() {
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(WikiRefreshProvider, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AppInner, {}) });
	}
	//#endregion
