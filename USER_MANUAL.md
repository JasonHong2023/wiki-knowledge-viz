...
選取看板後，點擊標題列右側的 **「匯出 ▼」** 下拉按鈕，選擇格式：

| 格式 | 副檔名 | 說明 |
|------|--------|------|
| Markdown | `.md` | 含總覽表格 + 各格詳細章節，可用 Obsidian / VS Code 開啟 |
| 圖片 | `.png` | 暗色主題九宮格截圖，中心格紫色高亮 |
| PowerPoint | `.pptx` | 單頁投影片，9 格文字可在 PowerPoint 內直接編輯 |
| Excel | `.xlsx` | 3×3 儲存格佈局，可在 Excel 內調整格式與內容 |
...
點擊看板標題右側「匯出 ▼」→ 選擇 Markdown / 圖片 / PowerPoint / Excel。
